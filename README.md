...
<p><strong>機能</strong><br>
 ...
 ・録音を週間スケジュールに設定できる。曜日ごとに、開始時間、ラジオ局の番号、長さ（分）、音量、終了後ON/OFFに「4」を指定する。<br>
　　例　13:00,1,59,1,4<br>
...
・SDカードへの書き込みでエラーが発生することがあり、SDカードの再フォーマットが必要になるケースがあります。<br>SDカードは専用とし、<br>
　 <strong>保存が必要なデータは絶対に置かないでください</strong>。<br>
